...
reads. [Step 4.9](LISTING_PREVIEW.md) adds private PREVIEW reads, and
[Step 4.10](LISTING_FEE.md) adds CALCULATE_FEE reads with the stored fee.
Other non-DRAFT reads return 404. Mutation of an
